...
void Huffman::storeCode(Fnode *huffman_tree, string pr){
...
void Huffman::addCode(int index, string c){
    code[index] = c;
}

//return the character whose code is given string or part of it
int Huffman::uncompress(string& str){
    unsigned int index;
...
string Huffman::getCode(int index){
    return code[index];
}
